    ...
    return (
      <div className={styles['About']}>
        <div className={styles['bio']}>
          <h1>I am an aspiring Full Stack Web Developer currently based in the Washington D.C. area.</h1>

          <h2>I specialize in designing and building interactive user interfaces that are conducive to a stimulating and engaging user experience.</h2>
